...
| [Rate Limit - Advanced](./advanced-ratelimit/v1.2/docs/advanced-ratelimit.md) | Security, AI | Rate limiting policy supporting multiple algorithms (GCRA, Fixed Window), multi-dimensional quotas, weighted rate limiting, flexible key extraction with optional match conditions, and in-memory, Redis, and Redis-local-async backends. |
