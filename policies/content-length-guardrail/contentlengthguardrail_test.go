...
func TestDisabledFlow_GetPolicyAndHandlers_NoRequiredParams(t *testing.T) {
	t.Run("request flow disabled", func(t *testing.T) {
		...
		action := p.OnRequest(&policyv1alpha.RequestContext{
			Body: &policyv1alpha.Body{Content: []byte(`{"messages":[{"content":"hello"}]}`)},
		}, nil)
	...
	t.Run("response flow disabled", func(t *testing.T) {
		...
		action := p.OnResponse(&policyv1alpha.ResponseContext{
			ResponseBody: &policyv1alpha.Body{Content: []byte(`{"choices":[{"message":{"content":"hello"}}]}`)},
		}, nil)
...
func TestOnRequestAndOnResponse(t *testing.T) {
	...
	reqDisabled := p.OnRequest(&policyv1alpha.RequestContext{Body: &policyv1alpha.Body{Content: []byte(`{"messages":[{"content":"hi"}]}`)}}, nil)
	...
	respDisabled := p.OnResponse(&policyv1alpha.ResponseContext{ResponseBody: &policyv1alpha.Body{Content: []byte(`{"choices":[{"message":{"content":"hi"}}]}`)}}, nil)
