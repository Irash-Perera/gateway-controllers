...
func (p *SemanticCachePolicy) Mode() policyv1alpha.ProcessingMode {
...
func (p *SemanticCachePolicy) OnRequest(ctx *policyv1alpha.RequestContext, params map[string]interface{}) policyv1alpha.RequestAction {
	var content []byte
	if ctx.Body != nil {
...
func (p *SemanticCachePolicy) OnRequestBody(ctx *policyv1alpha2.RequestContext, _ map[string]interface{}) policyv1alpha2.RequestAction {
	return p.processRequestBodyV2(ctx)
}

func (p *SemanticCachePolicy) processRequestBody(ctx *policyv1alpha.RequestContext) policyv1alpha.RequestAction {
	var content []byte
	if ctx.Body != nil {
		content = ctx.Body.Content
	}
...
func (p *SemanticCachePolicy) processRequestBodyV2(ctx *policyv1alpha2.RequestContext) policyv1alpha2.RequestAction {
	var content []byte
	if ctx.Body != nil {
		content = ctx.Body.Content
	}
...
// OnResponse handles response body processing for semantic caching in the v1alpha engine.
func (p *SemanticCachePolicy) OnResponse(ctx *policyv1alpha.ResponseContext, params map[string]interface{}) policyv1alpha.ResponseAction {
...
func (p *SemanticCachePolicy) processResponseBody(ctx *policyv1alpha.ResponseContext) policyv1alpha.ResponseAction {
	// Only cache successful responses (200 status code)
	if ctx.ResponseStatus != 200 {
		slog.Debug("SemanticCache: Skipping cache for non-200 response", "statusCode", ctx.ResponseStatus)
		return policyv1alpha.UpstreamResponseModifications{}
...
func isSSEResponse(headers *policyv1alpha.Headers) bool {
	if headers == nil {
		return false
	}
...
func (p *SemanticCachePolicy) buildErrorResponse(message string, err error) policyv1alpha.RequestAction {
	errorMsg := message
	if err != nil {
		errorMsg = fmt.Sprintf("%s: %v", message, err)
	}
