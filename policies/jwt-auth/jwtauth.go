...
func GetPolicyV2(
	...
	slog.Debug("JWT Auth Policy: GetPolicyV2 called")
	return ins, nil
}

// Mode returns the processing mode for this policy
func (p *JwtAuthPolicy) Mode() policyv1alpha2.ProcessingMode {
	return policyv1alpha2.ProcessingMode{
		RequestHeaderMode:  policyv1alpha2.HeaderModeProcess, // Process request headers for token
